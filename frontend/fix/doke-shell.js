(function(){
  window.__DOKE_SHELL_BUILD__ = "20260315v201";
  ...
  const GUEST_PROFILE_LOGIN_HREF = `login.html?noshell=1&next=${encodeURIComponent("meuperfil.html")}`;
    ...
    try{
      ...
      if (desktop && sidebar){
        ...
        if (!(link instanceof HTMLLinkElement)) {
          ...
          link.id = cssId;
          link.rel = "stylesheet";
          link.href = "doke-sidebar-compact.css?v=20260315v201";
          document.head.appendChild(link);
        } else if (!/doke-sidebar-compact\.css/i.test(String(link.href || ""))) {
          link.href = "doke-sidebar-compact.css?v=20260315v201";
        }
        return;
      }

      body.classList.remove("has-doke-sidebar", "doke-sidebar-expanded");
      if (link) {
...
async function ensureShell(){
    ...
    if (homeChromeDisabled || unifiedDesktopDisabled) {
      ...
      if (body) body.classList.remove("doke-structure-reform", "doke-sidebar-expanded");
...
const isPro = profile && (profile.isProfissional === true || profile.tipo === "profissional" || profile.role === "profissional");
    ...
    const profileHref = isLogged ? PAGES.perfil : GUEST_PROFILE_LOGIN_HREF;
    const protectedHref = (href) => isLogged ? href : `login.html?noshell=1&next=${encodeURIComponent(String(href || PAGES.perfil || "meuperfil.html"))}`;
    const linkAnunciar = isPro ? "anunciar.html" : "tornar-profissional.html";
    ...
    const guestItemHTML = `<a href="${GUEST_PROFILE_LOGIN_HREF}" class="dropdown-item"><i class='bx bx-log-in'></i> Entrar</a>`;
