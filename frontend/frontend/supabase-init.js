      ...
      el.innerHTML = `
        <div style="display:flex;gap:10px;align-items:flex-start;">
          <div style="flex:1;min-width:0;">
            <div style="font-weight:700;margin-bottom:6px;">CORS bloqueado — o Supabase não está autorizando seu endereço local</div>
            <div style="opacity:.92;">No Supabase Dashboard → <b>Project Settings</b> → <b>API</b> → <b>CORS</b> (Allowed origins), adicione <code style="background:rgba(255,255,255,.08);padding:1px 6px;border-radius:6px;">${origin}</code> e também <code style="background:rgba(255,255,255,.08);padding:1px 6px;border-radius:6px;">http://127.0.0.1:5500</code>. Salve e dê <b>Ctrl+Shift+R</b>.</div>
